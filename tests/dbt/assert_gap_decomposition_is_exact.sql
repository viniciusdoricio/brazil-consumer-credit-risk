...
-- (docs/analysis-design.md, section 1.4). Returns the rows where they don't, to 1e-12.

select pair_id, window_id, product_scope, income_band, gap, same_product_gap, product_mix_gap
