...
*Translated from the [Portuguese original](../index.qmd), which is the reference version.*
...
- **Payroll-deducted loans (*consignado*)** are repaid straight from a salary or pension, so they
  rarely go bad. They are mainly available to retirees, pensioners and public-sector employees.
...
3. **Track 15–90-day delinquency for `{python} N.fastest` every month.** It is rising faster than
   for other occupations while their portfolio is still growing, and it is the measure that doesn't
   depend on the accounting rule.
...
- **Correlation, not causation.** Nothing here says that changing occupation would change anyone's
  risk.
- **Occupation is a registry attribute.** It comes from the federal tax registry, not from the
  current job. "Other" holds about a quarter of the portfolio, and occupations were reclassified in
  several Januaries. Since 2017, `{python} N.unexplained_jumps` months saw a jump of more than
